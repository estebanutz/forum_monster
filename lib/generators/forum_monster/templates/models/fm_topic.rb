class FmTopic < ActiveRecord::Base
  
  # Associations
  has_many :fm_posts, :dependent => :destroy
  belongs_to :fm_forum, :counter_cache => true
  ...
  validates :fm_posts,   :presence => true, :allow_nil => false, :on => :update
